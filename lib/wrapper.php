...
function sidebar_path() {
  if ( is_page( '¿Quiénes Somos?' ) ):
    return new SageWrapping('templates/sidebar-quienes-somos.php');
  elseif ( is_home() or is_single() ) :
    return new SageWrapping('templates/sidebar-entradas.php');
  elseif ( tribe_is_event_query() ) :
    return new SageWrapping('templates/sidebar-eventos.php');
  else :
